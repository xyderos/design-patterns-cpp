...
class test_either_factory : public CPPUNIT_NS::TestCase {
	...
	CPPUNIT_TEST(test_either_factory_should_inject_the_correct_objects_in_construction);
	...
	void test_either_factory_should_inject_the_correct_objects_in_construction(void);
};
