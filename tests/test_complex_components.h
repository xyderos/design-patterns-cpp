...
class test_complex_components : public CPPUNIT_NS::TestCase {
	...
	CPPUNIT_TEST(test_complex_composite_should_generate_a_tree_and_include_other_compoments_agnostically);
	CPPUNIT_TEST(test_complex_composite_should_delete_a_compoment_from_the_tree_sucessfully);
	...
	void test_complex_composite_should_generate_a_tree_and_include_other_compoments_agnostically(void);
	void test_complex_composite_should_delete_a_compoment_from_the_tree_sucessfully(void);
};
