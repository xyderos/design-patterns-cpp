...
void
test_command::test_command_calling_with_simple_command_should_return_correct_values(void)
{
    ...
    test_command_calling_with_complex_command_should_return_correct_values(void)
{
    ...
    std::string expected("receiver:something:complexreceiver:something_else:command");
...
void
test_command::
    test_command_calling_with_no_command_handlers_should_return_empty_value(void)
{
    client *cl = new client;
