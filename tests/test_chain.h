...
class test_chain : public CPPUNIT_NS::TestCase {
	...
	CPPUNIT_TEST(test_chain_with_segments_and_invalid_value_should_return_default);
	...
	void test_chain_with_segments_and_invalid_value_should_return_default(void);
};
