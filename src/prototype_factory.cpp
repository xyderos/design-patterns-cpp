...
prototype_factory::prototype_factory() : prototypes_(
    {
        {type::original_wannabe, new wannabe_prototype("wannabe_prototype", 3)},
        {type::another_wannabe, new another_wannabe_prototype("another_wannabe_prototype", 4)},
    })
{}
