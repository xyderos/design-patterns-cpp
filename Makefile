...
LIBRARY_OBJECTS :=$(addprefix $(LIBRARY_OBJECTS_DIRECTORY)/, component.o leaf.o composite.o)
SHARED := -shared
...
TOBJS :=$(addprefix $(TESTS_DIRECTORY_OBJECTS)/, test_simple_component.o test_complex_components.o driver.o)
