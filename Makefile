...
LIBRARY_OBJECTS :=$(addprefix $(LIBRARY_OBJECTS_DIRECTORY)/, component.o concrete.o decorator.o either_decorator.o other_decorator.o)
SHARED := -shared
...
TOBJS :=$(addprefix $(TESTS_DIRECTORY_OBJECTS)/, test_decorators.o driver.o)
