...
LIBRARY_OBJECTS :=$(addprefix $(LIBRARY_OBJECTS_DIRECTORY)/, man.o saab.o scania.o volvo.o car.o truck.o abstract_factory.o either_factory.o other_factory.o)
SHARED := -shared
...
TOBJS :=$(addprefix $(TESTS_DIRECTORY_OBJECTS)/, test_either_factory.o test_other_factory.o driver.o)
