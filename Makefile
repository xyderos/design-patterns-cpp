...
LIBRARY_OBJECTS :=$(addprefix $(LIBRARY_OBJECTS_DIRECTORY)/, business_logic.o client.o command.o complex.o simple.o)
SHARED := -shared
...
TOBJS :=$(addprefix $(TESTS_DIRECTORY_OBJECTS)/, test_command.o driver.o)
